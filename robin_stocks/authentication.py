...
def login(username, password, expires_in=86400, scope='internal', by_sms=True, store_session=True,
    ...
    :param pickle_path: Specifies where to store the authentication pickle
    :type pickle_path: Optional[str]
    ...
    if os.path.isfile(pickle_path):
        ...
        if store_session:
            try:
                ...
                msg = """ERROR: There was an issue loading pickle file. 
                Authentication may be expired - logging in normally.""".format(e)
                print(msg)
