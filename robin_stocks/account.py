...
@helper.login_required
def post_symbols_to_watchlist(input_symbols, name='Default'):
...
@helper.login_required
def delete_symbols_from_watchlist(input_symbols, name='Default'):
    ...
    for item in positions_data:
        ...
        try:
            ...
            if float(item['average_buy_price']) == 0.0:
                ...
                percent_change = (float(price) - float(item['average_buy_price'])) * 100 / float(
            ...
            # ToDo: Broad exception without handling
            print(repr(e))
            pass
