...
latex_documents = [
    (master_doc, 'robin_stocks.tex', 'robin\\_stocks Documentation',
     'Joshua M Fernandes', 'manual'),
]
...
man_pages = [
    (master_doc, 'robin_stocks', 'robin_stocks Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'robin_stocks', 'robin_stocks Documentation',
     author, 'robin_stocks', 'One line description of project.',
     'Miscellaneous'),
]
